					...
					foreach ( $terms as $term ) {
						if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
							if($term->term_id == $current_term){
								$this->parent->set_render_attribute( 'term-list-item', 'class', ['ae-term-active', 'ae-icon-list-item ae-term-list-item'] );
							}else{
								$this->parent->set_render_attribute( 'term-list-item', 'class', ['ae-icon-list-item','ae-term-list-item']);
							}
						}else{
							if(is_archive()){
								if($term->term_id === $current_term){
